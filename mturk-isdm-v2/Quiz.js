var quizDelim = $("#quiz-delimeter"),
    ...
    Quiz = {
      ...
      activeQuestion: 0,
      cIndex: 2,
      condition: Math.floor(3 * Math.random()), // 0 = no hint, 1 = weak hint, 2 = strong hint
      questions: [
        {
          target: "accelerate",
      ...
      for (var q of Quiz.questions) {
                ...
                "<tbody>" +
                  ...
                  "<tr class='text-center'>" +
                    "<td colspan=3>" +
                      ...
                      // [!] Old code for mturk quiz, pre-Reccomendation algorithm
                      // "<table class='text-center'>" +
                      //   "<tr>" + 
                      //     "<td class=center>" +
                      //       "<div class='radio " + q.id + "_testchoices' style='display:none;'><label><input name='" + q.id + "_testans" + idAdd + "' type='radio' id=1 value='" + q.options[opOrder[1]].w + "' />" + q.options[opOrder[1]].w + "</label></div>" +
                      //     "</td>" +
                      //     "<td class=center>" +
                      //       "<div class='radio " + q.id + "_choices1' style='display:none;'><label><input name='" + q.id + "_ans" + idAdd + "' type='radio' value='" +  q.options[opOrder[1]].w + "' />" + q.options[opOrder[1]].w + " " + arrow1 + "</label></div>" +
                      //     "</td>" +
                      //     "<td>" +
                      //       "<div class='pointer " + q.id + "_pointer1' style='display:none;'> <label> &nbsp; &larr; Reccomended </label> </div>" +
                      //     "</td>" +
                      //   "</tr>" + 
                      //   "<tr>" + 
                      //     "<td class=center>" +
                      //       "<div class='radio " + q.id + "_testchoices' style='display:none;'><label =><input name='" + q.id + "_testans" + idAdd + "' type='radio' id=0 value='" + q.options[opOrder[0]].w + "' />" + q.options[opOrder[0]].w + "</label></div>" +
                      //     "</td>" +
                      //     "<td class=center>" +
                      //       "<div class='radio " + q.id + "_choices0' style='display:none;'><label><input name='" + q.id + "_ans" + idAdd + "' type='radio' value='" + q.options[opOrder[0]].w + "' />" + q.options[opOrder[0]].w + " " + arrow0 + "</label></div>" +
                      //     "</td>" +
                      //     "<td>" +
                      //       "<div class='pointer " + q.id + "_pointer0' style='display:none;'> <label> &nbsp; &larr; Reccomended </label>  </div>" +
                      //     "</td>" +
                      //     "</tr>" + 
                      // "</table>" +
                      ...
                      "<div class='grid-container'>" +
                        ...
                        "</div>" +
                        "<div class='box box5'>" +
                          "<div class='pointer " + q.id + "_pointer1' style='display:none;'>&larr; Recommended</div>" + 
                         "</div>" +
                        "<div class='grid-item'></div>" +
                        "<div class='box box3'>" +
                          "<div class='radio " + q.id + "_testchoices' style='display:none;'><label =><input name='" + q.id + "_testans" + idAdd + "' type='radio' id=0 value='" + q.options[opOrder[0]].w + "' />" + q.options[opOrder[0]].w + "</label></div>" +
                        ...
                        "</div>" +
                        "<div class='box box6'>" +
                          "<div class='pointer " + q.id + "_pointer0' style='display:none;'>&larr; Recommended</div>" +
                        "</div>" +
                      "</div>" +
                        "<div class='text-center'><style='display: none' disabled='true' onclick='next();' type='text' value='Continue' /></div>" +
                        "</td>" +

                  "</tr>" +
                "</tbody>" +
              "</table>" +
              "<div class='alert alert-info " + q.id + "_system' style='display:none;'> The system has reccomended an answer based on your initial response. </div>"  +
        ...
        (function (id, idAdd) {
          ...
          $("#" + id + "_reveal")
            .click(function () {
              $(this).hide();
              $("." + id + "_testchoices").show();
            });
          
          // Setup choice buttons for initial choices
          $("[name='" + id + "_testans" + idAdd + "']").click(function (event) {
            var val = $(this).val(),
            result,
            resultText,
            resultCSS,
            ...
            $("[name='" + id + "_testans" + idAdd + "']")
              .unbind("click")
              .attr("disabled", true);

            $("." + id + "_system").show();
            $("." + id + "_testchoices").hide();

            //Displays the final choices with arrows pointing to the option the user did not chose
            if(this.id == "1") {
              $("." + id + "_choices").show();
              $("." + id + "_pointer0").show();
            }
          ...
          // Setup choice buttons for final choices
